...
namespace APIVerve
{
    public class RandomQuoteAPIClient
    {
        ...
        public RandomQuoteAPIClient(string apiKey, bool isSecure = true)
        {
            _apiKey = apiKey;
            _isSecure = isSecure;
        }

        public RandomQuoteAPIClient(string apiKey, bool isSecure = true, bool isDebug = false)
        {
            _apiKey = apiKey;
            _isSecure = isSecure;
            _isDebug = isDebug;
        ...
        public ResponseObj Execute(randomquoteQueryOptions options)
        {
            try
            {
                if (_isDebug)
